...
def mcp_env(tmp_path: Path):
    ...
    with patch("personalclaw.dashboard.handlers.mcp._GLOBAL_MCP_JSON", mcp_json), \
         patch("personalclaw.dashboard.handlers.agents._installed_agent_config", return_value=agent_cfg):
