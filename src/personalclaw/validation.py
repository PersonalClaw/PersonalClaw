...
ALLOWED_HOOK_PROVIDERS = frozenset(
    {
        ...
        # provider §5 forbids.
        "selfqa-evidence",
        # SELF-VERIFICATION SV-11: the vcs trigger's action — commit delta + a start
        # delegated to `run-workflow`. Same §5 rule as its two siblings above; added here
        ...
        # PersonalClawApps, because the name resolves through the app provider registry at
