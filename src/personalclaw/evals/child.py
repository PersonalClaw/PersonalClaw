...
the cell's provider binding (:mod:`personalclaw.evals.cell_provider`) into the same throwaway
...
def spend_from_home() -> dict:
    ...
    (:data:`~personalclaw.evals.provenance.UNRECORDED`, never ``0``) the moment one contributing
