...
# digest. It is the pin's :meth:`~personalclaw.evals.pinning.RunPin.cell_model_fp`, which is a
...
# :func:`personalclaw.evals.provenance.state_of` reads them as unrecorded without a special case.
