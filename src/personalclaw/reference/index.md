...
2. Drill into the one relevant section:
   ...
   - **[routes.md](routes.md)** — 833 agent-callable HTTP routes (of 840 total), with summaries.
   - **[providers.md](providers.md)** — the provider-type taxonomy + 31 registered providers.
...
- `personalclaw-workflows` — 20 tools
