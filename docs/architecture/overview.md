...
- **Static frontend** — the SPA is a Vite + React app at `PersonalClaw/web/`,
...
| Tasks & triggers | [tasks-triggers.md](tasks-triggers.md) | `tasks/`, `triggers/`, `schedule.py`, `event_triggers.py` |
