...
6 atoms. **DC-2's implementation (T2.1-T2.4) landed 2026-08-13**; it stays `todo` only for V2's on-device walk-through (a launched Electron shell) and owner task 2's consent-copy approval — DC-3/DC-4/DC-5 can build against its contracts now. DC-2 is the independently-startable capability-bridge seam-owner; DC-3/4/5 hang off it; DC-1 carries the mac signing/updater pipeline; DC-5 and DC-6 carry the two cross-plan gates (INBOX-NOTIF, PLATFORM-REACH).
