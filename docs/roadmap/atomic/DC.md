...
6 atoms. **DC-2's implementation (T2.1-T2.4) landed 2026-08-13 and DC-3's (T3.1-T3.3) on 2026-08-16**; both stay `todo` only for their on-device walk-throughs (V2/V3 — a launched Electron shell on a real Mac) and their owner tasks — DC-4/DC-5 can build against their contracts now. DC-2 is the independently-startable capability-bridge seam-owner; DC-3/4/5 hang off it; DC-1 carries the mac signing/updater pipeline; DC-5 and DC-6 carry the two cross-plan gates (INBOX-NOTIF, PLATFORM-REACH).
