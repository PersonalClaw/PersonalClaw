...
- **Action providers:** none added; `ALLOWED_HOOK_PROVIDERS` (`src/personalclaw/validation.py`) is untouched. (Restated per platform rule: any future action provider must be added there or hook create/update rejects it.)
