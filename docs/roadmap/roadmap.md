...
| 67 | Sibling Hardening (KiroCrew) — Enforcement Floors, Trust Seams & Gate Ergonomics | [SIBLING-HARDENING-KIROCREW](plans/SIBLING-HARDENING-KIROCREW.md) | ~5 | 0/1 |
...
| 68 | Sibling Product Parity (KiroCrew) — UX Simplification, Artifacts-as-Apps, Onboarding Import & the App Suite | [SIBLING-PRODUCT-PARITY-KIROCREW](plans/SIBLING-PRODUCT-PARITY-KIROCREW.md) | ~12 | 1+2+3 |
