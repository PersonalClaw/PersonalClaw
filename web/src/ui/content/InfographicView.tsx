...
export function InfographicView({ content, mode }: PreviewProps) {
  ...
  if (failed) {
    return (
      <pre data-type="body-s" className="m-l overflow-auto rounded-lg bg-surface-low px-m py-m font-mono text-on-surface-low leading-relaxed whitespace-pre-wrap">{content}</pre>
    )
  }
  return (
