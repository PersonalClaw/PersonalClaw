...
const doc: UiDoc = {
  ...
  props: [
    ...
    { name: 'partial', description: 'The count is a cap the server applied, not the answer — announces "first 500 matches". The noun rule above applies to the caveat too: the files search painted "first 500 matches" while announcing a flat "500 matches", so the screen-reader user was the only one still being told the search had finished. Same word as PartialCount paints, deliberately.' },
