...
// nobody read). Those rows and their pass-through are covered by `hostPageConsent.test.tsx`
// and `consentPythonDeps.test.tsx`.
...
describe('the consent modal offers an override only when one exists', () => {
  it('a consentable warning keeps Cancel, because there is a pending action to abandon', () => {
    render(<ConsentModal hostUi={NOT_SUPPLIED} pythonDeps={NOT_SUPPLIED} label="demo-app" busy={false} onConfirm={() => {}} onClose={() => {}}
...
describe('the client-install branch reads as two sentences', () => {
  ...
  it("closes the server's unpunctuated reason before appending the instruction", () => {
    const { container } = render(<ConsentModal hostUi={NOT_SUPPLIED} pythonDeps={NOT_SUPPLIED} label="demo-app" busy={false} onConfirm={() => {}} onClose={() => {}}
      permissions={undefined} crons={undefined}
...
describe('the unsigned note agrees with the verdict beside it', () => {
  const modalText = (verdict: string) => {
    const { container } = render(<ConsentModal hostUi={NOT_SUPPLIED} pythonDeps={NOT_SUPPLIED} label="demo-app" busy={false}
...
describe('consentPermissions separates declared-none from not-known-yet', () => {
  ...
  it('the modal says the grants are unreadable for a pointer, not that there are none', () => {
    render(<ConsentModal hostUi={NOT_SUPPLIED} pythonDeps={NOT_SUPPLIED} label="remote-thing" busy={false} onConfirm={() => {}} onClose={() => {}}
  ...
  it('and it DOES say "none" for a manifest that really declared nothing', () => {
    render(<ConsentModal hostUi={NOT_SUPPLIED} pythonDeps={NOT_SUPPLIED} label="silent-app" busy={false} onConfirm={() => {}} onClose={() => {}}
