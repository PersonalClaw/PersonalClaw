...
import { DownloadCloud, CheckCircle2, RefreshCw, Undo2, X } from 'lucide-react'
    ...
    <div>
      ...
      <Section title="Release line" hint="Which releases this install follows. A version pin overrides the channel.">
        <RowGroup>
          ...
          <Field label="Version pin" hint="Stay on an exact release (e.g. 0.2.1) whatever the channel says — the update check and every apply respect it. Leave empty to follow the channel.">
            <div className="flex items-center gap-2">
              <TextInput value={pinDraft} onChange={setPinDraft} placeholder="0.2.1" ariaLabel="Version pin" size="sm" mono
      ...
      <Section title="Release notes" hint={info.pin ? `What is in the pinned release ${info.pin}.` : `What is in the newest ${channelName} release.`}>
        {releaseNotes.trim()
